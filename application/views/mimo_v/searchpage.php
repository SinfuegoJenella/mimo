					...
					$('[data-thoughtscommentid]').click(function(e) {
						...
						$.ajax({
							...
							success: function(s){
        						...
        						showCommentModal(comments,postid);
							},
							error: function(){
								console.log(e)
							}
