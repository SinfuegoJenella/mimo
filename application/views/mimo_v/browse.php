...
<div class="col-md-10" style="padding-top: 80px; margin-left: 100px;  ">
	...
	<div class="col-md-3 " >
		<div>
			<!--both a href link papunta sa playlist-->
			<div><a href="<?php echo base_url('mimo/playlist');?>"><img src="http://localhost/mimo/assets/img/vir_gl.jpg" class="img-rounded img-chart " style="width:200px; height; 200px;"></a></div>				
			<div><strong><a href="<?php echo base_url('mimo/playlist');?>" class="txt" style="color:black";>Global Viral 50</a></strong></div>
		</div>
	</div>
  </div>
