		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td style="color: white;">Love in Vain</td>
					<td style="color: white;">Robert Johnson</td>
					<td >
				...
				<tr>
					<td><i class="material-icons" style="color: #F97A16;;">music_note</i> </span> </button></td>
					<td style="color: white;">Tell Mama</td>
					<td style="color: white;">Etta James</td>
					<td>
						<button type="button">Add to Favourites</button> 
					</td>
				...
				<tr>
					<td><i class="material-icons" style="color: #F97A16;;">music_note</i></span> </button></td>
					<td style="color: white;">Evil</td>
					<td style="color: white;">Howlin' Wolf</td>
					<td>
						<button type="button">Add to Favourites</button> 
					</td>
				...
				<tr >
					<td><i class="material-icons" style="color: #F97A16;;">music_note</i></span> </button></td>
					<td style="color: white;">You Shook me</td>
					<td style="color: white;">Muddy Waters</td>
					<td>
						<button type="button">Add to Favourites</button> 
					</td>
				...
				<tr>
					<td><i class="material-icons" style="color: #F97A16;;">music_note</i></span> </button></td>
					<td style="color: white;">I'm so Glad</td>
					<td style="color: white;">Skip James</td>
					<td>
						<button type="button">Add to Favourites</button> 
					</td>
